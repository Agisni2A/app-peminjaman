...
<body>
            ...
            <li>
                ...
                <ul class="collapse show nav flex-column ms-1" id="submenu2" data-bs-parent="#menu">
                    <li class="w-100 active">
                        <a href="<?= site_url("/dashboard/mmenu/pinjam") ?>" class="nav-link text-dark px-4"> <span class="mx-3">Peminjaman</span></a>
                    </li>
                    <li>
    ...
    <div class="my-container">
        ...
        <div class="container pt-3">
            <div class="card" style="background-color: #100901;">
                <h5 class="card-header text-light">Master Asset</h5>
            </div>
            <div class="card p-2 mb-4">
                <table class="table table-striped nonwrap display" id="maset">
                    <thead>
                        <tr>
                            <th></th>
            ...
            <div class="card" style="background-color: #100901;">
                <h5 class="card-header text-light">Peminjaman Asset</h5>
            </div>
            <div class="card p-3">
                <form class="row g-3" id="pinjam">
                    <?= csrf_field() ?>
                    ...
                    <div class="col-md-3">
                        ...
                        <select class="form-select" name="kodeItemId[]" id="kodeItemId" multiple>
                            <?php foreach ($item as $items) : ?>
                                <?php if ($items['status'] == '0') : ?>
                                    <option value="<?= $items['kodeItemId']; ?>"><?= $items['kodeItemId']; ?></option>
                                <?php endif; ?>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control" name="namaItem" id="namaItem" disabled readonly>
                    </div>

                    <div class="space"></div>
                    <div class="col-md-3">
                        <label class="form-label">Tanggal Pinjam</label>
                        <input type="date" class="form-control" id="tglPeminjaman" name="tglPeminjaman" for="tglPeminjaman" required>
                    </div>
                    <div class="col-md-3">
                        <label for="warehouse" class="form-label">Lokasi Pinjam</label>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control" id="lokasiItem" name="lokasiItem" required>
                    </div>
                    <div class="col-md-3">
                ...
                <div class="card p-2 mt-4 ">
                    <table class="table table-striped nonwrap display" id="items" style="width: 100%; display: none">
                        <thead>
                            <tr>
    ...
    <!-- custom js -->
    <script src="/assets/js/pinjam.js"> </script>
